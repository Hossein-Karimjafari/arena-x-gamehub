...
export const GALLERY = [
  { emoji: "🖥️", title: "سالن PC — ۱۲ سیستم RTX", gradient: "purple" },
  { emoji: "🎮", title: "استیشن کنسول PS5", gradient: "cyan" },
  { emoji: "🛋️", title: "اتاق تیمی VIP", gradient: "pink" },
  { emoji: "☕", title: "کافه گیمینگ", gradient: "green" },
  { emoji: "🏆", title: "مراسم مسابقات", gradient: "violet" },
  { emoji: "🎧", title: "گوشه استریمرها", gradient: "cyan" },
];
